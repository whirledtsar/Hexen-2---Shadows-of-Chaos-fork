...
/*
 * SUB_TraceRange by whirledtsar -- Traces forward, up/down by vrange units, and side-to-side by hrange units. Assumes that makevectors has been run.
 */
