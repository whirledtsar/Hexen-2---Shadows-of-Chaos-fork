...
float result;
	...
	if (self.owner.classname=="monster_fallen_angel")
	...
	else if (self.owner.classname=="monster_mezzoman") {
		if (self.owner.strength>=3)	//Tiger
			result = ReflectMissile (other, REFLECT_AIMED, CE_MEZZO_REFLECT, 1, 0, 0, TRUE, 0);
		else if(!self.owner.strength)	//Just block it
		...
		result = ReflectMissile (other, REFLECT_REFLECT, 0, 1, 0, 0, FALSE, 0);
