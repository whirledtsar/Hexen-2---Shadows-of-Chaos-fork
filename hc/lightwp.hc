...
//			self.abslight=0;
	...
	//ws: added weaponframe normal16 to statement
	else if(self.weaponframe==$normal12 || self.weaponframe==$normal16 ||(self.weaponframe>=$fidle1 &&self.weaponframe<=$fidle16))
	{
		if(self.attack_finished<time)
		{
